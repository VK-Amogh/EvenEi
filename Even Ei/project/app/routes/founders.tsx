...
export function meta({ }: Route.MetaArgs) {
    return [
        { title: "Founders - EvenEi" },
        {
            name: "description",
            content: "Meet the minds behind EvenEi.",
        },
    ];
}
                            ...
                            <div key={founder.name} className={styles.founderCard}>
                                ...
                                <div className={styles.founderDetails}>
                                    ...
                                    <div className={styles.founderSocials}>
                                        <a href={founder.social.twitter} className={styles.founderSocialLink} aria-label="Twitter">
                                            <Twitter />
                                        </a>
                                        <a href={founder.social.linkedin} className={styles.founderSocialLink} aria-label="LinkedIn">
                                            <Linkedin />
                                        </a>
                                        <a href={founder.social.github} className={styles.founderSocialLink} aria-label="GitHub">
                                            <Github />
                                        </a>
                                    </div>
                                </div>
